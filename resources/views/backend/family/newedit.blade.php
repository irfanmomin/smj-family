    ...
    {{ Form::model($family, ['route' => ['admin.family.update', $family], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-family', 'files' => true]) }}
        <div class="box box-info">
            <div class="box-body">
                ...
                @if ( $isMainMember == true )
                    {{-- Main Member Surname --}}
                    <div class="form-group">
                        {{ Form::label('surname', trans('labels.backend.family.validationedit.surname'), ['class' => 'col-lg-2 control-label required']) }}
                        <div class="col-lg-10">
                            {!! Form::select('surname', config('smj.surname'), (isset($family->surname) ? $family->surname : '' ), ["class" => "form-control box-size", "placeholder" => trans('labels.backend.family.validationedit.surnameholder'), 'required' => 'required']) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                @else
                    {{-- Main Member Surname CHILD --}}
                    <div class="form-group">
                        {{ Form::label('surname', trans('labels.backend.family.validationedit.surname'), ['class' => 'col-lg-2 control-label required']) }}
                        <div class="col-lg-10">
                            {!! Form::select('surname', config('smj.surname'), (isset($mainMemberArray['surname']) ? $mainMemberArray['surname'] : '' ), ["class" => "form-control box-size", "placeholder" => trans('labels.backend.family.validationedit.surnameholder'), 'required' => 'required', 'disabled' => 'disabled' ]) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                @endif
                ...
                @if ( $isMainMember == false && !empty($mainMemberArray))
                    {{-- Main Meber Name --}}
                    <div class="form-group">
                        {{ Form::label('', trans('labels.backend.family.validationedit.mainmembername'), ['class' => 'col-lg-2 control-label required']) }}
                        <div class="col-lg-10">
                ...
                {{-- Main Member Gender --}}
                <div class="form-group">
                    {{ Form::label('gender', trans('labels.backend.family.validationedit.gender'), ['class' => 'col-lg-2 control-label required']) }}
                    <div class="col-lg-10">
                        {!! Form::select('gender', config('smj.gender'), (isset($family->gender) ? $family->gender : '' ), ["class" => "form-control box-size", "data-column" => 2, "placeholder" => trans('labels.backend.family.validationedit.genderholder'), 'required' => 'required']) !!}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                @if ( $isMainMember == true )
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {!! Form::select('city', $cityList, (isset($family->city) ? $family->city : '' ), ["class" => "form-control box-size", "data-column" => 2, 'required' => 'required']) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    {{-- Main Member Area --}}
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            {!! Form::select('area', $areaList, (isset($family->area) ? $family->area : '' ), ["class" => "form-control box-size", "data-column" => 2, "placeholder" => trans('labels.backend.family.validationedit.areaholder'), 'required' => 'required']) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                @else
                    {{-- Main Member City --}}
                    <div class="form-group">
                        {{ Form::label('city', trans('labels.backend.family.validationedit.city'), ['class' => 'col-lg-2 control-label required']) }}
                        <div class="col-lg-10">
                            {!! Form::select('city', $cityList, (isset($mainMemberArray['city']) ? $mainMemberArray['city'] : '' ), ["class" => "form-control box-size", "data-column" => 2, 'required' => 'required', 'disabled' => 'disabled']) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                    {{-- Main Member Area --}}
                    <div class="form-group">
                        {{ Form::label('area', trans('labels.backend.family.validationedit.area'), ['class' => 'col-lg-2 control-label required']) }}
                        <div class="col-lg-10">
                            {!! Form::select('area', $areaList, (isset($mainMemberArray['area']) ? $mainMemberArray['area'] : '' ), ["class" => "form-control box-size", "data-column" => 2, "placeholder" => trans('labels.backend.family.validationedit.areaholder'), 'required' => 'required', 'disabled' => 'disabled']) !!}
                        </div><!--col-lg-10-->
                    </div><!--form control-->
                @endif
