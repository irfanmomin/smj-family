        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('firstname', (isset($family->firstname) ? $family->firstname : '' ), ['class' => 'form-control box-size', 'pattern' => '^[a-zA-Z ]*$', 'title' => 'Only NAME is allowed', 'placeholder' => trans('labels.backend.family.validationedit.firstnameholder'), 'required' => 'required', 'onkeyup'=> "this.value = this.value.toUpperCase();"]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{ Form::text('lastname', (isset($family->lastname) ? $family->lastname : '' ), ['class' => 'form-control box-size', 'pattern' => '^[a-zA-Z ]*$', 'title' => 'Only NAME is allowed', 'placeholder' => trans('labels.backend.family.validationedit.lastnameholder'), 'required' => 'required', 'onkeyup' => "this.value = this.value.toUpperCase();"]) }}
                    </div><!--col-lg-10-->
                </div><!--form control-->
                {{-- Main Member Surname --}}
                <div class="form-group">
